    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("xxx xxx xxx")
                url.set("https://github.com/acktsap/xxx")
                licenses {
                    license {
                ...
                scm {
                    connection.set("scm:git:git://github.com/acktsap/xxx.git")
                    developerConnection.set("scm:git:ssh://github.com/acktsap/xxx.git")
                    url.set("https://github.com/acktsap/xxx")
                }
            }
        }
